            ...
            <div style={{
              ...
              <div style={{
                ...
                <Space>
                  ...
                  <span style={{ fontSize: '16px', fontWeight: 'bold', color: '#333' }}>快速提问</span>
                </Space>
              </div>
              ...
              <div style={{ 
                  ...
                  {quickQuestions.map((item, index) => (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                        <div style={{ color: MINING_BLUE_COLORS.primary, marginTop: '2px' }}>
                          {item.icon}
                        </div>
                ...
                <div style={{ marginTop: '24px', paddingTop: '20px', borderTop: '1px solid #e8e8e8' }}>
                  <Text strong style={{ fontSize: '14px', color: '#666' }}>助手特色</Text>
                  <div style={{ marginTop: '12px', display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                    <Tag color="blue">专业准确</Tag>
                    <Tag color="green">快速响应</Tag>
                    <Tag color="purple">知识丰富</Tag>
                  </div>
                </div>
              </div>
            </div>
