...
const statusConfig = {
  ...
  implemented: { color: 'purple', label: '已实现' },
  closed: { color: 'default', label: '已关闭' }
};

// 类型标签配置
const typeConfig = {
  bug_report: { color: 'red', label: '🐛 错误报告' },
  feature_request: { color: 'blue', label: '✨ 功能建议' },
  content_suggestion: { color: 'green', label: '📝 内容建议' },
  ui_improvement: { color: 'purple', label: '🎨 界面改进' },
  performance: { color: 'orange', label: '⚡ 性能问题' },
